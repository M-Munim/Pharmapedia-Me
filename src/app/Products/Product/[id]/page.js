...
//             {/* <h1 className="outlined-text m-0 p-0 text-white text-5xl lg:text-8xl xl:text-[140px]">{products.productName}<span className='inline xl:block'>PEDIA</span></h1> */}
//             <h1 className="outlined-text m-0 p-0 text-white text-5xl lg:text-8xl xl:text-[140px]">{products.productName}</h1>
        ...
        <div className="z-30 relative w-11/12 md:w-10/12 m-auto">
          ...
          <div className="flex flex-col xl:flex-row items-center xl:items-start justify-center mt-14">
            ...
            <div className="w-full md:w-7/12 flex  items-start justify-center tracking-wider gap-3">
              ...
              <div className="right">
                <div className="w-44 h-40 sm:w-48 sm:h-48 md:w-96 md:h-56 flex flex-col items-center justify-center mt-6 sm:mt-7 md:mt-20">
                  <div className="relative z-30">
                    <Image src="/Group 18909.svg" alt="" width={200} height={200} />
                  </div>
                </div>
                <div className="w-44 h-40 sm:w-48 sm:h-48 md:w-96 md:h-56 bg-white shadow-xl border-l-5 border-[#2AA7FF] rounded-md flex flex-col items-center justify-center mt-6 sm:mt-7 md:mt-20">
                  <div className="text-left">
